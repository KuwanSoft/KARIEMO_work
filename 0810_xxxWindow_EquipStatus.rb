...
#     self.contents.draw_text(4, 0, 108, WLH, @actor.name)

#     draw_armor(0, WLH * 1)
#     draw_parameter(0, WLH * 2, 0)
#     draw_parameter(0, WLH * 3, 3)
#     draw_parameter(0, WLH * 4, 2)
#   end
#   #--------------------------------------------------------------------------
#   # ● 装備変更後の能力値設定
#   #     new_atk : 装備変更後の攻撃力
...
#     self.contents.font.color = system_color
#     self.contents.draw_text(x + 92, y, 20, WLH, "→", 1)
#     if new_value != nil
#       self.contents.font.color = new_parameter_color(value, new_value)
#       self.contents.draw_text(x + 112, y, 60, WLH, new_value, 2)
#     end
#   end

#   def draw_armor(x, y)
#     self.contents.font.color = system_color
#     self.contents.draw_text(x + 4, y, 80, WLH, Vocab::def)
#     self.contents.font.color = normal_color
#     self.contents.draw_text(x + 122, y, 50, WLH, @actor.def, 2)
#   end
# end
